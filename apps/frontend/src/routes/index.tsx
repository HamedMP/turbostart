...
import { Rocket, Code, Database, Video, Bot, Zap, Server, ExternalLink, Plus } from 'lucide-react'
    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8 opacity-0 animate-fade-in-up delay-200">
            <TechBadge name="TanStack Start" href="https://tanstack.com/start" icon={Zap} />
            <TechBadge name="React 19" href="https://react.dev" icon={Code} />
            <TechBadge name="Bun" href="https://bun.sh" icon={Rocket} />
            <TechBadge name="Hono" href="https://hono.dev" icon={Server} />
            <TechBadge name="Drizzle" href="https://orm.drizzle.team" icon={Database} />
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="max-w-4xl mx-auto text-center text-muted-foreground text-sm">
          <p>Built with the Turbo Repo Template</p>
        </div>
      </footer>
    </main>
  )
